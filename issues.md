...
| ISS-005 | ハレーション塗りつぶしカラーの変更 | 現在のハレーション効果で使用される塗りつぶしレイヤーのカラーを、より暖色系のオレンジ色（R220 G89 B1 #dc5901）に変更したい。現在の設定では色温度が適切でない可能性 | main.jsのFILM_EFFECTS_CONFIG.halation.colorを指定色に変更。RGB値をR:220, G:89, B:1に修正する | nob | 🔴 未対応 | 🟢 Low | 2025-06-08 | 2025-06-08 |
